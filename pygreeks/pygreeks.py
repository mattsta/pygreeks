...
# Update: the IV math doesn't seem to work? It's heavily weighted
# towards just returning the IV provided as input for OTM options.
...
class Option:
    ...
    # current IV for stock price expressed as decimal percentage
    # (over whichever period you find relevant)
    underlying_iv: float
